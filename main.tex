...
\citeauthor{Asai2016} proposed a Random Depth tiebreaking (\citeyear{Asai2016}) and its deterministic version (\citeyear{asai2017tie}), resulting in significant performance improvements in the zero-cost domains. 
