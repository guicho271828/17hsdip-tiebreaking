...
\begin{table*}[htbp]
 ...
 \caption{
 Coverage results with { \lmcut and \mands for computing $f$ and inadmissible distance-to-go heuristics for tie-breaking, on 620 Zerocost instances}. We highlight the best results when the difference between the maximum and the minimum coverage exceeds 2.
 }
...
\begin{table*}[htbp]
 ...
 \caption{
 Coverage results with { \lmcut and \mands for computing $f$ and using the same heuristics $h$ for tie-breaking, on 1104 IPC instances}.
 }
 \label{tbl:dtg-lmcut-zero}
 }
\end{table*}
...
\begin{table*}[htbp]
 {
 %% now lmcut table and mands table are combined
 \relsize{-3}
 \centering
...
\begin{table*}[htbp]
 ...
 \caption{
 Coverage results with \lmcut and \mands for computing $f$ and inadmissible distance-to-go heuristics for tie-breaking, on 1104 standard IPC benchmark instances.
 }
