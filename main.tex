...
\begin{abstract}
 ...
 This allows for a finer theoretical analysis on the completeness of A* on infinite graphs and also a new algorithms.
 As one such instance, we investigate a second, new class of tie-breaking strategy, 
